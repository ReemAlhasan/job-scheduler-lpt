...
public class Scheduler {
	...
	public Scheduler(Machine[] machineArray) {
		machines = machineArray; // Fix: Initialize the class field, not a local variable
	}
	...
	public void printSchedule() {
		for (int i = 0; i < machines.length; i++) { // Fix: Index starts from 0 and doesn't have an index equal to the length
